	...
	$(document).ready(function(){
		...
		$("#project_form_<?php echo $ajax_session_id;?>").on('submit',function(e){
			if (validationPass)
			{
				...
				$.ajax({
					type: 'post',
					url:  $('#project_form_<?php echo $ajax_session_id;?>').attr('action') + '?ajax_session_id=<?php echo $ajax_session_id;?>&ajax_id=<?php echo $ajax_id;?>&is_ajax=true&project_id=<?php echo $project_data[0]->project_id;?>',
					data: {
