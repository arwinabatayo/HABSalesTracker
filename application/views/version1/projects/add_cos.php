											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<h4 class="modal-title"><?php echo lang('projects_add_cost_of_sale');?></h4>
													</div>
													<div class="modal-body">
														
														
														<div id="project_cost_of_sale_form_wrapper_<?php echo $ajax_session_id.$project_data[0]->project_id;?>" class="ajax-wrapper">
															...
															<?php echo form_open(site_url('projects/add_cos'),array('role' => 'form','id' => 'project_cost_of_sale_form_'.$ajax_session_id.$project_data[0]->project_id));?>
